...
class AdminAppBarSearch extends StatelessWidget implements PreferredSizeWidget {
  final double _height;
  final double _width;
  final String _title;
  final TextEditingController _textController = TextEditingController();

  AdminAppBarSearch(this._height, this._width, this._title);
          ...
          return AppBar(
            ...
            bottom: PreferredSize(
              ...
              child: Padding(
                ...
                child: TextField(
                  onChanged: (value) {
                    Provider.of<ProductModelView>(context, listen: false)
                    ...
                    suffixIcon: Consumer<SpeechRecognitionProvider>(
                      builder: (context, provider, child) {
                        return AvatarGlow(
                          ...
                          glowColor: provider.isListening
                              ? Colors.blueGrey
                              : Colors.white,
                          repeat: true,
