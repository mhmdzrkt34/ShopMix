...
class HomeView extends StatelessWidget  {
  ...
  Selector<darkModeProvider,bool> ScaffoldSelector(){
    ...
    builder: (context, value, child){
      ...
      appBar: AppBarComponent(height: _deviceHeight*0.1,backtickenabled: false,actionsColors: GetIt.instance.get<ColorsDesign>().light[1],backgroundColor:GetIt.instance.get<ColorsDesign>().light[0] ,deviceWidth: _deviceWidth,threeTapEnable: true,),
