...
class ColorsDesign {
  ...
  final List<Color> light=[Color.fromARGB(255, 243, 238, 238),Color.fromARGB(255, 0, 0, 0),Color.fromARGB(255, 255, 0, 0),Color.fromARGB(255, 146, 143, 143),Colors.white,Color.fromARGB(255, 117, 125, 135),Colors.blue,Color.fromARGB(255, 146, 143, 143)];
